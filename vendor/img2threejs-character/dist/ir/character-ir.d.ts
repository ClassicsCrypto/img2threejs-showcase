...
export type SurfaceFeatureRepresentation = "texture" | "material-mask" | "decal" | "surface-curve" | "normal-detail" | "height-detail" | "geometry-relief";
...
export type EvidenceConfidenceMap = Record<string, {
    confidence: number;
    state: EvidenceState;
    reason?: string;
}>;
...
export type SemanticRelation = "parent" | "continuous-with" | "articulates-with" | "attached-to" | "covers" | "grows-from" | "deforms-with" | "mirrors" | "surface-bound";
...
export type ProportionBindingTarget = {
    kind: "loft-section-center";
    ids: string[];
    axes: TransformAxis[];
    origin?: Vec3;
} | {
    kind: "loft-section-size";
    ids: string[];
    components: Array<"width" | "depth">;
} | {
    kind: "rig-joint-position";
    ids: string[];
    axes: TransformAxis[];
    origin?: Vec3;
} | {
    kind: "accessory-position";
    ids: string[];
    axes: TransformAxis[];
    origin?: Vec3;
} | {
    ...
    kind: "landmark-position";
    ids: string[];
    axes: TransformAxis[];
    origin?: Vec3;
} | {
    kind: "face-skull-radius";
    axes: TransformAxis[];
} | {
    kind: "hand-digit-point";
    handIds: string[];
    axes: TransformAxis[];
    origin?: Vec3;
};
...
export type TopologyIntent = "deformable-organic" | "rigid-surface" | "fiber" | "shell" | "explicit";
...
export type AccessoryPrimitive = "anchor" | "box" | "ellipsoid" | "dodecahedron" | "cylinder" | "cone" | "torus" | "polygon";
...
export interface CharacterIR {
    ...
    landmarkGraph: {
        landmarks: FacialLandmark[];
        semanticToId: Record<string, string>;
    };
...
export declare function emptyCharacterEvidence(): CharacterEvidence;
export declare function createCharacterIR(name: string, archetype: CharacterArchetype, profile?: "lite" | "standard" | "hero"): CharacterIR;
